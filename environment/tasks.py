...
TASK_3_SCENARIOS = [
    {
        ...
        "log_map": {
            "api-gateway": [
                LogEntry(timestamp="2024-06-17T02:59:50Z", service="api-gateway", level="ERROR", message="Upstream fraud-detection timeout after 25 s"),
                LogEntry(timestamp="2024-06-17T02:59:52Z", service="api-gateway", level="ERROR", message="Redis CLUSTER SLOTS returned CLUSTERDOWN error"),
            ],
            "order-service": [
                LogEntry(timestamp="2024-06-17T02:59:55Z", service="order-service", level="ERROR", message="Cannot connect to redis-cluster:6379 — CLUSTERDOWN"),
                LogEntry(timestamp="2024-06-17T02:59:56Z", service="order-service", level="ERROR", message="Session store unavailable — rejecting checkout"),
            ],
            "fraud-detection": [
                LogEntry(timestamp="2024-06-17T02:59:45Z", service="fraud-detection", level="ERROR", message="ml-feature-store connection refused on :9200"),
                LogEntry(timestamp="2024-06-17T02:59:46Z", service="fraud-detection", level="ERROR", message="Feature lookup timeout — cannot score transaction"),
            ],
            "warehouse-pipeline": [
                LogEntry(timestamp="2024-06-17T02:59:40Z", service="warehouse-pipeline", level="ERROR", message="Redis Streams consumer: CLUSTERDOWN state detected"),
                LogEntry(timestamp="2024-06-17T02:59:41Z", service="warehouse-pipeline", level="ERROR", message="Aborting ETL batch — no events readable from stream"),
            ],
            "ml-feature-store": [
                LogEntry(timestamp="2024-06-17T02:58:00Z", service="ml-feature-store", level="ERROR", message="Primary shard unassigned — cluster health RED"),
                LogEntry(timestamp="2024-06-17T02:58:05Z", service="ml-feature-store", level="ERROR", message="Node ml-feature-store-1 evicted — disk 98% full"),
                LogEntry(timestamp="2024-06-17T02:58:10Z", service="ml-feature-store", level="ERROR", message="Write-ahead log cannot flush — no disk space"),
            ],
            "redis-cluster": [
                LogEntry(timestamp="2024-06-17T02:58:30Z", service="redis-cluster", level="ERROR", message="Cluster node redis-2 unreachable — PFAIL"),
                LogEntry(timestamp="2024-06-17T02:58:35Z", service="redis-cluster", level="ERROR", message="redis-2 marked FAIL — cluster enters CLUSTERDOWN"),
                LogEntry(timestamp="2024-06-17T02:58:36Z", service="redis-cluster", level="ERROR", message="redis-2 disk 99% — append-only file corrupted"),
            ],
            "postgres-primary": [
                LogEntry(timestamp="2024-06-17T03:00:00Z", service="postgres-primary", level="INFO",  message="All connections healthy — no anomalies"),
            ],
        },
        "ground_truth": {
    ...
    },
    {
        ...
        "log_map": {
            "api-gateway": [
                LogEntry(timestamp="2024-08-01T00:00:00Z", service="api-gateway", level="ERROR", message="TLS: certificate has expired — notAfter=2024-07-31T23:58:00Z"),
                LogEntry(timestamp="2024-08-01T00:00:01Z", service="api-gateway", level="ERROR", message="SSL_CTX_use_certificate: certificate verify failed — rejecting all connections"),
            ],
            "mobile-backend": [
                LogEntry(timestamp="2024-08-01T00:00:03Z", service="mobile-backend", level="ERROR", message="x509: certificate has expired or is not yet valid"),
                LogEntry(timestamp="2024-08-01T00:00:04Z", service="mobile-backend", level="ERROR", message="HTTPS listener shutdown — cannot bind expired certificate"),
            ],
            "partner-api": [
                LogEntry(timestamp="2024-08-01T00:00:05Z", service="partner-api", level="ERROR", message="Mutual TLS: peer certificate verification failed — chain expired"),
            ],
            "cert-manager": [
                LogEntry(timestamp="2024-07-28T12:00:00Z", service="cert-manager", level="WARN",  message="Certificate *.platform.io expiring in 3 days — renewal pending"),
                LogEntry(timestamp="2024-07-31T22:00:00Z", service="cert-manager", level="ERROR", message="ACME challenge failed — DNS propagation timeout"),
                LogEntry(timestamp="2024-07-31T23:58:00Z", service="cert-manager", level="ERROR", message="Certificate *.platform.io EXPIRED — renewal failed 3 times"),
            ],
            "health-monitor": [
                LogEntry(timestamp="2024-08-01T00:01:00Z", service="health-monitor", level="ERROR", message="SSL check *.platform.io: EXPIRED 2 minutes ago"),
                LogEntry(timestamp="2024-08-01T00:01:01Z", service="health-monitor", level="ERROR", message="Certificate renewal blocked: DNS challenge token not found at /.well-known/acme-challenge/"),
            ],
            "postgres-primary": [
                LogEntry(timestamp="2024-08-01T00:01:00Z", service="postgres-primary", level="INFO",  message="All connections healthy — no anomalies"),
            ],
        },
        "ground_truth": {
            "category": IncidentCategory.CONFIGURATION_ERROR,
