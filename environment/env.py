...
# Maximum step penalty fraction (applied per wasted step after budget exceeded)
...
class IncidentResponseEnv:
    ...
    def step(self, action: Action) -> Tuple[Observation, Reward, bool, Dict[str, Any]]:
        ...
        if action.action_type == ActionType.CLASSIFY:
            ...
            step_score = 0.05  # small signal — human escalation is valid
    ...
    def _handle_investigate(self, action, log_map, obs):
        ...
        if svc in obs.investigations_done:
            # Penalise re-investigating the same service
        ...
        score = 0.10  # base reward for any investigation
        # Bonus: log entries indicate something interesting
